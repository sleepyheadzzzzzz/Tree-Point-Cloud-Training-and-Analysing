...
The QGIS **Tree Growth Waterfall** tool connects a matched raster package to a
...
2. Install the ZIP and open **Plugins → Tree Growth → Tree Growth Waterfall**.
...
The archived July 28 suitability/change maps were generated by the older
deployment model. They cannot be retrospectively labelled as explanations of
the later three-soil model. At implementation time, the original `F:` source
drive was unavailable. A separately labelled **225-observed-cell demonstration**
was therefore generated locally and tested in QGIS 3.40.11. It is not a
wall-to-wall replacement and is not published as new study-wide evidence.
Full-area production regeneration requires the original aligned spatial
predictors, including soil, and any intended period-specific noise inputs.
