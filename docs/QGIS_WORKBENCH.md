...
An experimental research plugin for four connected steps: **train and compare →
finalize and test → spatial diagnosis → click-based interpretation**. It does
...
Restart QGIS when upgrading an already loaded version. Open **Plugins → Tree
