# Legacy Urban Tree Carbon and Spatial Analysis Tool

This directory preserves the repository's preliminary six-stage workflow and sample data. The current manuscript-aligned workflow is documented in the repository-root `README.md`.
